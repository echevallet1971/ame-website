  ...
  return (
    <div className="split-timeline relative">
      ...
      >
        ...
        <span className={`text-2xl font-semibold ${isCurrentPhase ? 'text-white' : 'text-brand-royal-blue-dark'}`}>
          {phase}
        </span>
      </div>
      ...
      <div className="flex-1 md:pt-4">
        <h3 className={`item-heading mb-3 ${isCurrentPhase ? 'text-brand-gold' : 'text-brand-royal-blue-dark'}`}>
          {title}
        </h3>
