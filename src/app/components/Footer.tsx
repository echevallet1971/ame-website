        ...
        <div className="py-12">
          <div className="grid-footer">
            ...
            <div className="md:justify-self-end">
              <h4 className="text-meta font-semibold text-brand-royal-blue-dark mb-4">Legal</h4>
              <ul className="stack-xs">
                <li>
                  <a 
                    href="#" 
                    onClick={handleContactClick}
                    className="text-meta text-brand-gray hover:text-brand-royal-blue-dark transition-colors cursor-pointer"
                  >
                    Contact
                  </a>
                </li>
                <li>
                  <Link href="/privacy" className="text-meta text-brand-gray hover:text-brand-royal-blue-dark transition-colors">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link href="/terms" className="text-meta text-brand-gray hover:text-brand-royal-blue-dark transition-colors">
                    Terms of Service
                  </Link>
                </li>
              </ul>
          ...
          <div className="mt-12 pt-8 border-t border-brand-border">
            <p className="text-meta text-brand-gray text-center">
