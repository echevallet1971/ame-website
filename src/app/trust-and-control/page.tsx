      ...
      <section className="section-standard bg-gray-50">
        <div className="container-5xl">
          <div className="flow-xl items-center">
            <h1 className="section-heading text-brand-royal-blue-dark text-center">
            ...
            <div className="w-full max-w-5xl grid-two">
              <Card className="rounded-xl p-6 md:p-8">
                <p className="item-heading text-brand-royal-blue-dark mb-3">
            ...
            <p className="max-w-4xl text-lead font-medium text-brand-royal-blue-dark text-center">
